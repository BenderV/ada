    ...
    <div class="flex flex-col w-full max-w-2xl h-full">
      ...
      <div class="w-full py-2 lg:py-4">
        ...
        >
          ...
          <div class="flex flex-col" v-if="aiSuggestions && aiSuggestions.length">
...
watch(databaseSelected, async () => {
  aiSuggestions.value = []
  await fetchAISuggestions()
})

const fetchAISuggestions = async () => {
  const response = await axios.get(`/api/databases/${databaseSelected.value.id}/questions`)
